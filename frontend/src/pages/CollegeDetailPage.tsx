    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 flex flex-col font-sans">
        ...
        <div className="max-w-4xl mx-auto p-12 text-center my-auto">
          ...
          <Link
            to="/"
            className="mt-5 inline-flex items-center gap-1.5 bg-indigo-600 text-white font-semibold px-5 py-2.5 rounded-xl text-xs shadow-xs hover:bg-indigo-700"
          >
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1 space-y-3">
                <div className="flex items-center gap-2 flex-wrap">
                  <Link
                    to="/"
                    className="text-xs font-semibold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 px-3 py-1 rounded-xl transition-all shadow-xs flex items-center gap-1"
                  >
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "cutoffs" && (
            ...
            >
              ...
              {/* Redesigned Pending Cutoff Warning Banner */}
              {selectedYear === 2026 && currentYearObj?.is_pending ? (
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-5 text-amber-900 dark:text-amber-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0 w-full md:w-auto">
                    <button
                      ...
                      className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-3.5 py-2 rounded-xl text-xs shadow-xs transition-all flex-1 md:flex-none text-center"
                    >
                      View 2025 Cutoffs
                    </button>
                    <Link
                      to="/chat"
                      className="bg-indigo-700 hover:bg-indigo-800 text-white font-bold px-3.5 py-2 rounded-xl text-xs shadow-xs transition-all flex-1 md:flex-none text-center"
                    >
                      AI Rank Predictor →
                    </Link>
                  </div>
